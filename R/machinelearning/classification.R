...
png("Plots/classification-plots-04.png", width=864, height=432, pointsize=12)
par(mfrow=c(1,2), mgp=c(1.25,.5,0), mar=c(2.25, 2.1, 1,1))
...
png("Plots/classification-plots-05.png", width=432, height=432, pointsize=12)
...
library(ellipse)
png("Plots/classification-plots-06.png", width=864, height=432, pointsize=12)
par(mfrow=c(1,2), mgp=c(1.25,.5,0), mar=c(2.25, 2.1, 1,1))
...
png("Plots/classification-plots-08.png", width=432, height=432, pointsize=12)
