...
dat=read.table("../Data/olive.txt",sep=",")
...
# plot the olive data
png("Plots/tree-plots-02.png", width=432, height=432, pointsize=12)
...
png("Plots/tree-plots-03.png", width=432, height=432, pointsize=12)
par(mgp=c(1.25,.5,0), mar=c(2.25, 2.1, 1,1))
par(las=1)
plot(eicosenoic,linoleic,type="n")
points(eicosenoic,linoleic,col=mycol[Region],cex=0.7,pch=15)
...
png("Plots/tree-plots-04.png", width=432, height=432, pointsize=12)
par(mgp=c(1.25,.5,0), mar=c(2.25, 2.1, 1,1))
...
# plot iris data
png("Plots/tree-plots-05.png", width=432, height=432, pointsize=12)
...
png("Plots/tree-plots-06.png", width=432, height=432, pointsize=12)
par(las=1,xaxs="i",yaxs="i")
par(mgp=c(1.25,.5,0), mar=c(2.25, 2.1, 1,1))
plot(c(0.9,7),c(0,2.6),xlab="petal length",ylab="petal width",type="n")
abline(v=2.45)
...
# plot iris tree
png("Plots/tree-plots-07.png", width=432, height=432, pointsize=12)
...
# now plot
png("Plots/tree-plots-10.png", width=432, height=432, pointsize=12)
