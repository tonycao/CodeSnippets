...
png("Plots/regression-plots-01.png", width=432, height=432, pointsize=12)
...
png("Plots/regression-plots-02.png", width=432, height=432, pointsize=12)
...
png("Plots/regression-plots-03.png", width=432, height=432, pointsize=12)
plot(train.xx, train.y, cex=.6, main="CD4 counts vs. Time", xlab="Time since zero conversion", ylab="CD4")
...
png("Plots/regression-plots-04.png", width=432, height=432, pointsize=12)
plot(train.xx, train.y, cex=.6, main="CD4 counts vs. Time", xlab="Time since zero conversion", ylab="CD4")
abline(lmfit, col="red", lwd=2)
...
png("Plots/regression-plots-05.png", width=432, height=432, pointsize=12)
plot(train.xx, train.y, cex=.6, main="CD4 counts vs. Time", xlab="Time since zero conversion", ylab="CD4")
abline(lmfit, col="red", lwd=2)
...
png("Plots/regression-plots-06.png", width=432, height=432, pointsize=12)
...
png("Plots/regression-plots-07.png", width=432, height=432, pointsize=12)
...
png("Plots/regression-plots-08.png", width=432, height=432, pointsize=12)
